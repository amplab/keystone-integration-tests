...
spark-submit \
  ...
  --driver-library-path /home/eecs/shivaram/openblas-install/lib:$FWDIR/../lib:$KEYSTONE_DIR/lib \
  --conf spark.executor.extraLibraryPath=/home/eecs/shivaram/openblas-install/lib:$FWDIR/../lib:$KEYSTONE_DIR/lib \
